          ...
          >
            <div className="mb-3 flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="text-base font-bold text-kiosk-navy">{label(selected)}</h3>
                {selected.department && (
            ...
            {description(selected) && (
              <p className="mb-3 text-sm leading-relaxed text-gray-600">{description(selected)}</p>
            )}

            <div className="mb-3 space-y-2 rounded-xl bg-kiosk-bg px-3 py-2.5 text-sm text-gray-700">
            ...
            {selected.navigationQuery ? (
              <Link
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-kiosk-green px-4 py-2.5 text-sm font-bold text-white transition-transform hover:scale-[1.01] active:scale-[0.99]"
              >
