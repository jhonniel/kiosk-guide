...
export function buildBuildingUiConfig(
  ...
  return {
    ...
    kioskLocation: {
      ...
      x: Number(getSetting(settings, "building_kiosk_x", "468")) || 468,
      y: Number(getSetting(settings, "building_kiosk_y", "455")) || 455,
      locationId: getSetting(settings, "building_kiosk_location_id", "gf-kiosk"),
      nodeId: getSetting(settings, "building_kiosk_node_id", "gf_kiosk"),
